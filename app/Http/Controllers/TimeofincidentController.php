...
class TimeofincidentController extends Controller
{
    public function index()
    {
        ...
        ->where(function($query) {
            $query->Where('fxr_terms.term_id', 2490)
                ->orWhere('fxr_terms.term_id', 2491)
                ->orWhere('fxr_terms.term_id', 2650)
                ->orWhere('fxr_terms.term_id', 2663)
                ->orWhere('fxr_terms.term_id', 2664);
            })
        ->get();
